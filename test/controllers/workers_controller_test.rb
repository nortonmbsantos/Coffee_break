...
class WorkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create worker" do
    assert_difference('Worker.count') do
      post workers_url, params: { worker: { Occupation_id: @worker.Occupation_id, name: @worker.name } }
    end
  ...
  test "should update worker" do
    patch worker_url(@worker), params: { worker: { Occupation_id: @worker.Occupation_id, name: @worker.name } }
